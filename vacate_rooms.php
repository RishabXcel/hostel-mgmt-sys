	...
	<header>
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h1><a class="navbar-brand"  href="home.php" target="_blank">
					HMS </a></h1>
...
<section class="contact py-5">
	<div class="container">
		<h2 class="heading text-capitalize mb-sm-5 mb-4"> Vacate Room </h2>
			<div class="mail_grid_w3l">
				<form action="vacate_rooms.php" method="post">
					<div class="row">
						<div class="col-md-7 contact_left_grid" data-aos="fade-right">
							<div class="contact-fields-w3ls">
								<b>Username:</b><input type="text" name="roll_no" placeholder="Username" required >
							</div>
							<div class="contact-fields-w3ls">
							<b>Hostel:</b><input type="text" name="hostel" placeholder="Hostel" value="<?php echo $hostel_name;?>" required="" disabled="disabled">
							</div>
							<div class="contact-fields-w3ls">
