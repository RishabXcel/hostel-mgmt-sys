	...
	<header>
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h1><a class="navbar-brand" href="admin_home.php">In <span class="display"></span></a></h1>
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="admin_home.php"> <span class="display"> </span></a>
		</div>
		<div class="footer-grid">
			...
			<div class="agileits_w3layouts-copyright mt-4 text-center">
				<p>© 2018 Intrend. All Rights Reserved | Design by Rishab&Shahid</p>
		</div>
		</div>
	</div>
</footer>
