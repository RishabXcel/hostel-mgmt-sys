					...
					<div class="row">
						<div class="col-md-6 contact_left_grid" data-aos="fade-right">
							<div class="contact-fields-w3ls">
								<b>Admin Name:</b><input type="text" name="name" placeholder="Name"  value="<?php echo $_SESSION['username']; ?>"required="">
							</div>
							<div class="contact-fields-w3ls">
							<b>Hostel Name:</b><input type="text" name="hostel_name" placeholder="Hostel" required="" value="<?php echo $hostel_name; ?>">
							</div>
							<div class="contact-fields-w3ls">
							<b>Username:</b><input type="text" name="student_roll_no" placeholder="Username" required="">
							</div>
							<div class="contact-fields-w3ls">
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="http://www.nitc.ac.in/" target="_blank"><span class="display"> HOSTEL MANAGEMNET SYSTEM</span></a>
		</div>
