...
<body>
        ...
        <form action="includes/signup.inc.php" method="POST">
            ...
            <div class=" w3l-form-group">
                ...
                <div class="group">
                    ...
                    <input type="text" class="form-control" name="student_roll_no" placeholder="Enter username" required="required" />
                </div>
            </div>
            <div class=" w3l-form-group">
    ...
    <footer>
        <p class="copyright-agileinfo"> &copy; 2080 Project. All Rights Reserved | Design by Rishab & Shahid</a></p>
    </footer>
