	...
	<header>
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h1><a class="navbar-brand" href="home_manager.php">HMS</a></h1>
...
<?php
    ...
    <div class="container">
      ...
      <b>Message:</b><div class="card-body"><?php echo $row['message']; ?></div> 
      <b>Username:</b><div class="card-footer"><?php echo $row['sender_id'] ?><span style="float: right"><?php echo $row['msg_date']." ".$row['msg_time']; ?></span></div>
  </div>
</div>
<br><br>
...
<footer class="py-5">
	<div class="container py-md-5">
		...
		<a class="navbar-brand"  href="home.php" target="_blank"><span class="display"> HOSTEL MANAGEMENT SYSTEM</span></a>		</div>
