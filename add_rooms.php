...
<html lang="en">
<head>
<title>R&S HOSTEL BOOKING SYSTEM</title>
...
<section class="contact py-5">
	<div class="container">
		<h2 class="heading text-capitalize mb-sm-5 mb-4"> Add Rooms </h2>
			<div class="mail_grid_w3l">
				<form action="add_rooms.inc.php" method="post">
					<div class="row">
						<div class="col-md-7 contact_left_grid" data-aos="fade-right">
							<div class="contact-fields-w3ls">
								<b>Hostel Type:</b> <br> <select style="width:100% !important; height:50px !important;" name="hostel_type">
  ...
  <option value="6">F</option>
							...
							<!-- <div class="contact-fields-w3ls">
							<b>Type</b><input type="text" name="hostel" placeholder="Type" value="<?php echo $hostel_name;?>" required="" disabled="disabled">
							</div> -->
							<div class="contact-fields-w3ls">
							<b>Room number:</b><input type="number" name="room_no" placeholder="Room Number" required="">
							</div>
						</div>
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="index.html"><span class="display"> HOSTEL MANAGREMENT SYSTEM</span></a>
		</div>
		<div class="footer-grid">
			<div class="social mb-4 text-center">
				<ul class="d-flex justify-content-center">
					<li class="mx-2"><a href="https://www.facebook.com/rishabpokharel25"><span class="fab fa-facebook-f"></span></a></li>
			...
			<div class="agileits_w3layouts-copyright mt-4 text-center">
				<p>© 2080 Project. All Rights Reserved | Design by Rishab & Shahid </a></p>
		</div>
		</div>
	</div>
</footer>
